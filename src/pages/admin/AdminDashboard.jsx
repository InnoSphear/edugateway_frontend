...
const AdminDashboard = () => {
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', background: '#f8fafc' }}>
      <aside style={{ width: '260px', background: 'white', borderRight: '1px solid #e2e8f0', padding: '24px 16px', position: 'fixed', height: '100vh', overflowY: 'auto' }}>
        ...
        <nav style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
          {menuItems.map(item => (
            <Link key={item.path} to={item.path} style={{
              ...
              textDecoration: 'none', color: '#475569', fontSize: '14px', fontWeight: 500, transition: 'all 0.2s'
            }}
              onMouseEnter={e => { e.target.style.background = '#f1f5f9'; e.target.style.color = item.color; }}
